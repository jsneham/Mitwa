...
public class AppConstants {
    ...
    //staging url
    public static final String BASE_URL = "http://www.milann.in/";
//    public static final String BASE_URL = "http://www.jeevanjodidar.com/";

    //production url
    //public static final String BASE_URL = "https://advanced.matrimonyscript.com/";

    public static final String PAYMENT_LOGO_PREFIX_URL = BASE_URL + "assets/payment_logo/";//Working
    public static final String BIRTH_DATE_FORMAT_New = "dd/MM/yyyy";
    public static final String DIRECTORY_NAME = "Advanced Matrimony";
...
//    public static final String add_video = BASE_URL + "upload/add_video";
    public static final String add_video = BASE_URL + "upload/upload_video_photo";
    public static final String delete_id_proof_photo = BASE_URL + "upload/delete_id_proof_photo";
    public static final String delete_video_proof_photo = BASE_URL + "upload/delete_video_photo";
    ...
    public static final String other_user_profile_for_mobile = BASE_URL + "search/view_profile_app_for_mobile";
    ...
    public static final long MAX_VIDEO_SIZE_IN_MB_TO_UPLOAD = 20;
