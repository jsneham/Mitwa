...
import com.matriapp.mobile.adapter.SuccessStoryListAdapter;
import com.matriapp.mobile.model.SuccessStoryBean;
...
public class SuccessWeMetFragment extends Fragment implements SuccessStoryListAdapter.ItemListener {
    ...
    private void getSuccessStoryList() {
        if (!ConnectionDetector.isConnectingToInternet(getActivity())) {
            common.showToast( "Please check your internet connection!", recyclerView);
            return;
        }
        ...
        call.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, retrofit2.Response<JsonObject> response) {
                ...
                if (data != null) {
                    ...
                    common.showToast( "Something went to wrong!", recyclerView);
                }
            }
