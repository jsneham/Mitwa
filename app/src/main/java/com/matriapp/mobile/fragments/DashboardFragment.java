...
import com.matriapp.mobile.activities.CustomMatchActivity;
import com.matriapp.mobile.activities.DashboardActivityCopy;
...
import com.matriapp.mobile.activities.SuccessStoryActivity;
import com.matriapp.mobile.activities.ViewMyProfileActivity;
import com.matriapp.mobile.activities.ViewedProfileActivity;
...
public class DashboardFragment extends Fragment implements View.OnClickListener, EasyPermissions.PermissionCallbacks {
    ...
    private DashboardActivityCopy activity;
    private View view;
...
//    private CardView layoutInboxCount, layoutShortlistCount, layoutMatchesCount, layoutInterestCount;
    ...
    public void initialize() {
        ...
        activity = ((DashboardActivityCopy) getActivity());
        ...
        locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                if (locationResult.getLastLocation() != null) {
                    ...
                    AppDebugLog.print("milan location : " + currentLocation.getLatitude() + "," + currentLocation.getLongitude());
                    //getMyprofile();
