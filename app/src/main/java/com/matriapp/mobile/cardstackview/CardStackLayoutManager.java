package com.matriapp.mobile.cardstackview;
...
import com.matriapp.mobile.cardstackview.internal.CardStackSetting;
import com.matriapp.mobile.cardstackview.internal.CardStackSmoothScroller;
import com.matriapp.mobile.cardstackview.internal.CardStackState;
import com.matriapp.mobile.cardstackview.internal.DisplayUtil;
...
public class CardStackLayoutManager
    ...
    private void update(RecyclerView.Recycler recycler) {
        ...
        if (state.isSwipeCompleted()) {
             ...
             *
             * 2019-03-31 18:44:29.744 8496-8496/com.matriapp.mobile.cardstackview.sample E/AndroidRuntime: FATAL EXCEPTION: main
             *     Process: com.matriapp.mobile.cardstackview.sample, PID: 8496
             *     java.lang.IllegalStateException: Cannot call this method while RecyclerView is computing a layout or scrolling com.matriapp.mobile.cardstackview.CardStackView{9d8ff78 VFED..... .F....ID 0,0-1080,1353 #7f080027 app:id/card_stack_view}, adapter:com.matriapp.mobile.cardstackview.sample.CardStackAdapter@e0b8651, layout:com.matriapp.mobile.cardstackview.CardStackLayoutManager@17b0eb6, context:com.matriapp.mobile.cardstackview.sample.MainActivity@fe550ca
             ...
             *         at com.matriapp.mobile.cardstackview.sample.MainActivity.paginate(MainActivity.kt:164)
             *         at com.matriapp.mobile.cardstackview.sample.MainActivity.onCardSwiped(MainActivity.kt:50)
             *         at com.matriapp.mobile.cardstackview.CardStackLayoutManager.update(CardStackLayoutManager.java:277)
             *         at com.matriapp.mobile.cardstackview.CardStackLayoutManager.scrollHorizontallyBy(CardStackLayoutManager.java:92)
