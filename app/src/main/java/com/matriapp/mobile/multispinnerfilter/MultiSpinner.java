...
public class MultiSpinner extends AppCompatSpinner implements DialogInterface.OnCancelListener {
    ...
    public boolean performClick() {
        ...
        builder = new android.app.AlertDialog.Builder(getContext(), R.style.FullScreenDialogStyle);
        ...
        view.findViewById(R.id.btnCancel).setOnClickListener(view1 -> ad.dismiss());

        view.findViewById(R.id.btnSave).setOnClickListener(view1 -> ad.dismiss());
