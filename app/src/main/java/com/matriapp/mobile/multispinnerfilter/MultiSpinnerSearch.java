...
public class MultiSpinnerSearch extends AppCompatSpinner implements OnCancelListener {
    ...
    public boolean performClick() {
        ...
        // Set BottomSheet to expand fully
        FrameLayout bottomSheet = bottomSheetDialog.findViewById(com.google.android.material.R.id.design_bottom_sheet);
        BottomSheetBehavior<View> behavior = BottomSheetBehavior.from(bottomSheet);
        behavior.setPeekHeight(BottomSheetBehavior.PEEK_HEIGHT_AUTO);
        behavior.setState(BottomSheetBehavior.STATE_EXPANDED);

        behavior.setHideable(false); // Prevent the bottom sheet from being hidden
        ...
        btnCloseDialog.setOnClickListener(view1 -> bottomSheetDialog.dismiss());
...
//            positiveButton.setTextColor(getResources().getColor(android.R.color.white)); // Example: White text color
//            positiveButton.setBackgroundResource(R.drawable.round_background); // Example: Blue background color
//
//            // Get the layout parameters of the button
//            ViewGroup.LayoutParams params = positiveButton.getLayoutParams();
//
//            // Set custom width and height
//            params.width = getResources().getDimensionPixelSize(R.dimen.dp40); // Example: Custom width
//            params.height = getResources().getDimensionPixelSize(R.dimen.dp30); // Example: Custom height
//            positiveButton.setPadding(0, 0, 0, 0);
//
//
//            if (params instanceof ViewGroup.MarginLayoutParams) {
//                int marginInPixels = getResources().getDimensionPixelSize(R.dimen.dp8); // Example: Custom margin in pixels
//                ViewGroup.MarginLayoutParams marginParams = (ViewGroup.MarginLayoutParams) params;
//                marginParams.setMargins(0,marginInPixels,marginInPixels,0); // Set margin
//            }
//
//
...
//        });
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            Typeface customFont = Typeface.createFromAsset(getContext().getAssets(), "font/medium_slnt.ttf");
            holder.textView.setTypeface(customFont);
            holder.textView.setTextColor(ContextCompat.getColor(getContext(), R.color.default_small_text_title1));
...
//                holder.textView.setTypeface(null, Typeface.BOLD);
                Typeface customFont1 = Typeface.createFromAsset(getContext().getAssets(), "font/semi_bold_slnt.ttf");
                holder.textView.setTypeface(customFont1);
        ...
        public void clearSelection() {
            if (mOriginalValues != null) {
                arrayList.clear(); // Clear the current list
                arrayList.addAll(mOriginalValues); // Update current list to match the original list
                selected = 0; // Reset selected count
