...
//        bottomSheetDialog = new BottomSheetDialog(getContext());
        ...
        View view = inflater.inflate(R.layout.alert_dialog_listview_search_single, null);
        bottomSheetDialog.setContentView(view);

        // Set BottomSheet to expand fully and prevent collapsing
...
//        });
    ...
    public class MyAdapter extends BaseAdapter implements Filterable {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            convertView = inflater.inflate(R.layout.item_listview_single_spinner, parent, false);
