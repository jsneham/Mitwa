package com.matriapp.mobile.autoimageslider;
...
import com.matriapp.mobile.autoimageslider.IndicatorView.PageIndicatorView;
import com.matriapp.mobile.autoimageslider.IndicatorView.animation.type.BaseAnimation;
import com.matriapp.mobile.autoimageslider.IndicatorView.animation.type.ColorAnimation;
import com.matriapp.mobile.autoimageslider.IndicatorView.animation.type.IndicatorAnimationType;
import com.matriapp.mobile.autoimageslider.IndicatorView.draw.controller.DrawController;
import com.matriapp.mobile.autoimageslider.IndicatorView.draw.data.Orientation;
import com.matriapp.mobile.autoimageslider.IndicatorView.draw.data.RtlMode;
import com.matriapp.mobile.autoimageslider.IndicatorView.utils.DensityUtils;
import com.matriapp.mobile.autoimageslider.InfiniteAdapter.InfinitePagerAdapter;
import com.matriapp.mobile.autoimageslider.Transformations.AntiClockSpinTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.Clock_SpinTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.CubeInDepthTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.CubeInRotationTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.CubeInScalingTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.CubeOutDepthTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.CubeOutRotationTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.CubeOutScalingTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.DepthTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.FadeTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.FanTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.FidgetSpinTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.GateTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.HingeTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.HorizontalFlipTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.PopTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.SimpleTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.SpinnerTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.TossTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.VerticalFlipTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.VerticalShutTransformation;
import com.matriapp.mobile.autoimageslider.Transformations.ZoomOutTransformation;

import static com.matriapp.mobile.autoimageslider.IndicatorView.draw.controller.AttributeController.getRtlMode;
    ...
    public void setSliderTransformAnimation(SliderAnimations animation) {
        ...
        switch (animation) {
            case ANTICLOCKSPINTRANSFORMATION:
                mSliderPager.setPageTransformer(false,(SliderPager.PageTransformer) new AntiClockSpinTransformation());
                break;
            case CLOCK_SPINTRANSFORMATION:
                mSliderPager.setPageTransformer(false,(SliderPager.PageTransformer) new Clock_SpinTransformation());
                break;
            case CUBEINDEPTHTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new CubeInDepthTransformation());
                break;
            case CUBEINROTATIONTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new CubeInRotationTransformation());
                break;
            case CUBEINSCALINGTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new CubeInScalingTransformation());
                break;
            case CUBEOUTDEPTHTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new CubeOutDepthTransformation());
                break;
            case CUBEOUTROTATIONTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new CubeOutRotationTransformation());
                break;
            case CUBEOUTSCALINGTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new CubeOutScalingTransformation());
                break;
            case DEPTHTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new DepthTransformation());
                break;
            case FADETRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new FadeTransformation());
                break;
            case FANTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new FanTransformation());
                break;
            case FIDGETSPINTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new FidgetSpinTransformation());
                break;
            case GATETRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new GateTransformation());
                break;
            case HINGETRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new HingeTransformation());
                break;
            case HORIZONTALFLIPTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new HorizontalFlipTransformation());
                break;
            case POPTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new PopTransformation());
                break;
            case SPINNERTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new SpinnerTransformation());
                break;
            case TOSSTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new TossTransformation());
                break;
            case VERTICALFLIPTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new VerticalFlipTransformation());
                break;
            case VERTICALSHUTTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new VerticalShutTransformation());
                break;
            case ZOOMOUTTRANSFORMATION:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new ZoomOutTransformation());
                break;
            default:
                mSliderPager.setPageTransformer(false, (SliderPager.PageTransformer) new SimpleTransformation());
