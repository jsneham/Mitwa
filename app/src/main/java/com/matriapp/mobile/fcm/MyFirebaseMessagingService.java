package com.matriapp.mobile.fcm;
...
//        showNotificationMessage(getApplicationContext(), data.get(KEY_TITLE), data.get(KEY_BODY), ts.toString(), pendinIntent);
    ...
    private void showNotificationMessage(Context context, String title, String message, String timeStamp, Intent intent) {
        String defaultMessage = "No message available"; // Define a default message if needed
        String processedMessage = message != null ? message : defaultMessage;
        Spanned spannedMsg = Html.fromHtml(processedMessage);
