...
public class RegistrationCasteActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener {
    ...
    private String caste_id = "", religion_id,ragister_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registration_caste);
    ...
    private void setList() {
        ...
        CustomFilterAdapter adapter = new CustomFilterAdapter(casteArrayList, "", this, getContext());
...
//                adapter.getFilter().filter(s.toString());
    ...
    @Override
    public void onItemsClick(KeyPairBoolData data, int position, String id) {
//        editText.setText("");
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationSubCasteActivity.class);
    ...
    private void getDependentList() {
        ...
        HashMap<String, String> param = new HashMap<>();
        param.put("get_list", "caste_list");
        param.put("currnet_val", religion_id);
        param.put("multivar", "");
        param.put("retun_for", "");
