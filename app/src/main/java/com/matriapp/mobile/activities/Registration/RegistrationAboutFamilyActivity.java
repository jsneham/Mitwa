...
public class RegistrationAboutFamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registration_about_family);
    ...
    public void validFirst(View view) {
        ...
        String family_details = et_about.getText().toString().trim();
        if (TextUtils.isEmpty(family_details)) {
    ...
    private void goToNextActivity() {
        Intent in = new Intent(this, RegistrationLastActivity.class);
