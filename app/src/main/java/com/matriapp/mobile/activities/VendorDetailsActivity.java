...
import com.matriapp.mobile.adapter.ImageSliderAdapter;
import com.matriapp.mobile.application.MyApplication;
import com.matriapp.mobile.model.VendorModel;
...
import com.matriapp.mobile.autoimageslider.SliderAnimations;
import com.matriapp.mobile.autoimageslider.SliderView;
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                if (data != null) {
                    if (data.get("status").getAsString().equalsIgnoreCase("success")) {
                        ...
                        Common.showToast(getString(R.string.err_msg_something_went_wrong),llProfileCreate);
                    }
                }
            }
