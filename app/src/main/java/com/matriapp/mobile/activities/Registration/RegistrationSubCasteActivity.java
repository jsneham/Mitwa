...
public class RegistrationSubCasteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registration_sub_caste);
    ...
    private void goToNextActivity() {
        Intent in = new Intent(this, RegistrationMotherToungeActivity.class);
