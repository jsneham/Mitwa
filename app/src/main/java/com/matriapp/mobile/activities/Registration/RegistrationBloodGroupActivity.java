...
public class RegistrationBloodGroupActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regis_blood_group);
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationAboutActivity.class);
