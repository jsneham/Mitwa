...
public class RegistrationFamilyTypeActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    private Common common;
    private SessionManager session;
    private RecyclerView rvList;
    private RelativeLayout progressBar,llProfileCreate;
    private ProgressBar pbState;
    private String family_type_id = "", ragister_id;
    private EditText editText;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_family_type);
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationFamilyDetailsActivity.class);
