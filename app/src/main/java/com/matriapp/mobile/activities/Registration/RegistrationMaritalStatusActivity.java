...
public class RegistrationMaritalStatusActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener {
    ...
    private  String mari_id="",ragister_id, mari_type;
    private EditText editText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_marital_status);
    ...
    private void goToNext() {
        if(mari_type.equalsIgnoreCase("Never Married") || mari_type.equalsIgnoreCase("Annulled")){
            Intent in = new Intent(this, RegistrationHeightActivity.class);
            in.putExtra("ragister_id",ragister_id);
            startActivity(in);
        }
        else {
            Intent in = new Intent(this, RegistrationTotalChildrenActivity.class);
            in.putExtra("ragister_id",ragister_id);
            startActivity(in);
        }
