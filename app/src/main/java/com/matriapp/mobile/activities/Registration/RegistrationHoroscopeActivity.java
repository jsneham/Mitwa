...
public class RegistrationHoroscopeActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    ...
    private String horo_id = "", ragister_id;
    private EditText editText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_horoscope);
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationStarActivity.class);
