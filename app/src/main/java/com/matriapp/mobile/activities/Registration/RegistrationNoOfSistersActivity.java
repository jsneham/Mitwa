...
public class RegistrationNoOfSistersActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    private Common common;
    private SessionManager session;
    private RecyclerView rvList;
    private RelativeLayout progressBar,llProfileCreate;
    private ProgressBar pbState;
    private String no_sis_id = "", ragister_id,noOf="";
    private EditText editText;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_no_of_sisters);
    ...
    private void goToNext() {
        if(!noOf.equalsIgnoreCase("0")) {
            Intent in = new Intent(this, RegistrationSistersMarriedActivity.class);
            in.putExtra("ragister_id", ragister_id);

            startActivity(in);
        }
        else {
            Intent in = new Intent(this, RegistrationAboutFamilyActivity.class);
            in.putExtra("ragister_id", ragister_id);
