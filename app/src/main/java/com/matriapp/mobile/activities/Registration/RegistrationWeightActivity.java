...
public class RegistrationWeightActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    ...
    private String weight_id = "", ragister_id;
    private EditText editText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_weight);
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationEatingActivity.class);
