...
public class RegistrationNoOFBrothersActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    ...
    private String no_bro_id = "", ragister_id, noOf="";
    private EditText editText;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_no_ofbrothers);
    ...
    private void goToNext() {
        if(!noOf.equalsIgnoreCase("0")) {
            Intent in = new Intent(this, RegistrationBrotherMarriedActivity.class);
            in.putExtra("ragister_id", ragister_id);
            startActivity(in);
        }
        else {
            Intent in = new Intent(this, RegistrationNoOfSistersActivity.class);
            in.putExtra("ragister_id", ragister_id);
            startActivity(in);
        }
    }
