...
public class RegistrationHealthActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener {
    ...
    private  String physicalinfo_id="",ragister_id;
    private EditText editText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_health);
    ...
    private void setList() {
        ...
        al = setupListForRecyclerView("physical_info");
    ...
    private void goToNextActivity() {
        Intent in = new Intent(this, RegistrationSkinActivity.class);
