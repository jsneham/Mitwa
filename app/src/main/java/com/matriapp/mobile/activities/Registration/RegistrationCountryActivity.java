...
public class RegistrationCountryActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    ...
    private String country_id = "", ragister_id;
...
//        editText.setText("");
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationStateActivity.class);
