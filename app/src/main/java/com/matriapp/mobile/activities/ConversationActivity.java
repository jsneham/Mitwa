...
import com.matriapp.mobile.fcm.NotificationUtils;
import com.matriapp.mobile.model.ConversationItem;
...
public class ConversationActivity extends AppCompatActivity {
    ...
    private String matri_id,username,other_id;
...
//        });
    ...
    public void onNewIntent(Intent intent) {
        ...
        if (b != null && b.containsKey("username")) {
            if (!b.getString("username").equals(username)) {
                username = b.getString("username" +
                        "" +
                        "");
                if (is_mark) {
        ...
        if (hashMap != null) {
            if (hashMap.containsKey("data_msg")) {
                ...
                try {
                    ...
                    if (obj.getString("sender").equals(username)) {
    ...
    private void getList() {
        ...
        common.makePostRequest(AppConstants.conversation, param, response -> {
            ...
            try {
                ...
                AppDebugLog.print("response in conversation activity : "+object);
                opposite_user_data = object.getJSONObject("opposite_user_data");
                other_id= opposite_user_data.getString("id");

                if (opposite_user_data.getString("photo_url").equals(getString(R.string.female_pic)) || opposite_user_data.getString("photo_url").equals(getString(R.string.male_pic)))
        ...
        common.makePostRequest(AppConstants.send_message, param, response -> {
            ...
            try {
                ...
                if (object.getString("status").equals("success")) {
                    ...
                    common.showToast(object.getString("error_message"),llView);
                }
            } catch (JSONException e) {
                e.printStackTrace();
                common.showToast(getString(R.string.err_msg_try_again_later),llView);
