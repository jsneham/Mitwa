...
public class RegistrationDrinkingActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    ...
    private String drink_id = "", ragister_id;
    private EditText editText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_drinking);
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationBloodGroupActivity.class);
