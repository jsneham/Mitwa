...
public class RegistrationHighEducationActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    ...
    private String edu_id = "", ragister_id;
    private EditText editText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_high_education);
...
//        editText.setText("");
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationWorkingSectorActivity.class);
