...
public class RegistrationReligionActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener {
    ...
    private String religion_id = "", ragister_id;
    private EditText editText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_religion);
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationCasteActivity.class);
        in.putExtra("ragister_id", ragister_id);
        in.putExtra("religion_id", religion_id);
        startActivity(in);
    }
