...
import com.matriapp.mobile.fragments.ExpressReceivedFragment;
import com.matriapp.mobile.fragments.ExpressSentFragment;
...
public class ExpressInterestActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ExpressSentFragment("all_sent"), "Sent");
        adapter.addFragment(new ExpressReceivedFragment("all_receive"), "Received");
