...
public class RegistrationProfessionActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    ...
    private String occu_id = "", ragister_id;
    private EditText editText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_profession);
...
//        editText.setText("");
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationAnnualIncomeActivity.class);
