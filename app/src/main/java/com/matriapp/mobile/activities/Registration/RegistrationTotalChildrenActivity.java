...
public class RegistrationTotalChildrenActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener {
    private Common common;
    private SessionManager session;
    private RecyclerView rvList;
    private RelativeLayout progressBar,llProfileCreate;
    private ProgressBar pbState;
    private  String total_child_id="",ragister_id, total_child="";
    private EditText editText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_total_children);
    ...
    private void setList() {
        ...
        al = setupListForRecyclerView("total_children");
    ...
    public void onItemsClick(KeyPairBoolData data, int position, String tag) {
        ...
        total_child_id = data.getId();
        total_child = data.getName();
        param.put("total_children", getValidId(total_child_id));
    ...
    private void goToNext() {
        if(total_child.equalsIgnoreCase("None")) {
            Intent in = new Intent(this, RegistrationHeightActivity.class);
            in.putExtra("ragister_id", ragister_id);
            startActivity(in);
        }
        else {
            Intent in = new Intent(this, RegistrationChildrenStatusActivity.class);
            in.putExtra("ragister_id", ragister_id);
            startActivity(in);
        }
    }
