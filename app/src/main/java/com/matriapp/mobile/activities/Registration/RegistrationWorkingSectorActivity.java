...
public class RegistrationWorkingSectorActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    ...
    private String emp_id = "", ragister_id;
    private EditText editText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_working_sector);
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationProfessionActivity.class);
