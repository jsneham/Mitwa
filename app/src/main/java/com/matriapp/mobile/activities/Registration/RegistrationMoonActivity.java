...
public class
RegistrationMoonActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    ...
    private String moon_id = "", ragister_id;
    private EditText editText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_moon);
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationBirthActivity.class);
