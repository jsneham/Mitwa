...
public class RegistrationMotherToungeActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    ...
    private  String tongue_id,ragister_id;
    private EditText editText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_mother_tounge);
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationPartnerActivity.class);
