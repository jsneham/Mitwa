...
public class RegistrationCityActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    ...
    private String city_id = "", state_id,ragister_id;
    private EditText editText;
    private ArrayList<KeyPairBoolData> cityArrayList = new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_city);
    ...
    private void setList() {
        ...
        CustomFilterAdapter adapter = new CustomFilterAdapter(cityArrayList, "", this, getContext());
...
//        editText.setText("");
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationHighEducationActivity.class);
    ...
    private void getDependentList() {
        ...
        HashMap<String, String> param = new HashMap<>();
        param.put("get_list", "city_list");
        param.put("currnet_val", state_id);
        param.put("multivar", "");
        param.put("retun_for", "");
        ...
        common.makePostRequest(AppConstants.common_depedent_list, param, response -> {
            ...
            try {
                ...
                if (object.getString("status").equals("success")) {
                    ...
                    cityArrayList.addAll(common.getSpinnerListFromArray(jsonArray));
                    setList();
