...
public class RegistrationFamilyStatusActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener {
    private Common common;
    private SessionManager session;
    private RecyclerView rvList;
    private RelativeLayout progressBar,llProfileCreate;
    private ProgressBar pbState;
    private String family_status_id = "", ragister_id;
    private EditText editText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_family_status);
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationFamilyTypeActivity.class);
