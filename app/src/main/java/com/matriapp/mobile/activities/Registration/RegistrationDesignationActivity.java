...
public class RegistrationDesignationActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    ...
    private String desig_id = "", ragister_id;
    private EditText editText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_designation);
    ...
    private void setList() {
        ...
        al = setupListForRecyclerView("designation_list");
...
//        editText.setText("");
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationAdditionProfessionActivity.class);
