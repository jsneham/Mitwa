...
public class RegistrationAdditionProfessionActivity extends AppCompatActivity {
    ...
    private EditText et_Profession_Info;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_addition_profession);
    ...
    public void validFirst(View view) {
        ...
        String professional_additional_info = et_Profession_Info.getText().toString().trim();
        if (TextUtils.isEmpty(professional_additional_info)) {
            et_Profession_Info.setError("Please enter info");
            isvalid = false;
        }
        if (isvalid) {
            HashMap<String, String> param = new HashMap<>();
            param.put("professional_additional_info", professional_additional_info);
    ...
    private void goToNextActivity() {
        Intent in = new Intent(this, RegistrationHealthActivity.class);
