...
public class RegistrationAnnualIncomeActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    ...
    private String income_id = "", ragister_id;
    private EditText editText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_annual_income);
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationDesignationActivity.class);
