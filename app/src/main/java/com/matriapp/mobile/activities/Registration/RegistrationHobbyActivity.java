...
public class RegistrationHobbyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registration_hobby);
    ...
    public void validFirst(View view) {
        ...
        if (TextUtils.isEmpty(hobby)) {
            et_hoby.setError("Please mention Hobbies & Interest(s)");
            isvalid = false;
        }
        if (isvalid) {
    ...
    private void goToNextActivity() {
        Intent in = new Intent(this, RegistrationLanguageActivity.class);
