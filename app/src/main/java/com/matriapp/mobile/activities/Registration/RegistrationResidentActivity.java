...
public class RegistrationResidentActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    private Common common;
    private SessionManager session;
    private RecyclerView rvList;
    private RelativeLayout progressBar,llProfileCreate;
    private ProgressBar pbState;
    private String resi_id = "", ragister_id;
    private EditText editText;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_resident);
    ...
    private void setList() {
        ...
        al = setupListForRecyclerView("residence");
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationFamilyStatusActivity.class);
