...
public class NewWelcomeActivity extends AppCompatActivity implements  EasyPermissions.PermissionCallbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnNewUser).setOnClickListener(view -> {
            startActivity(new Intent(NewWelcomeActivity.this, RegistrationReferredByActivity.class));
        });

        findViewById(R.id.btnExistingAccount).setOnClickListener(view -> {
            startActivity(new Intent(NewWelcomeActivity.this, LoginActivity.class));
        });
        findViewById(R.id.tvOption).setOnClickListener(view -> {
            startActivity(new Intent(NewWelcomeActivity.this, NewWelcomeTwoActivity.class));
        });
    ...
    private void singleTextView1(TextView textView) {
        ...
        spanText.setSpan(new ClickableSpan() {
            ...
            public void updateDrawState(TextPaint textPaint) {
                textPaint.setColor(ContextCompat.getColor(NewWelcomeActivity.this, R.color.blue_color));    // you can use custom color
        ...
        textView.setHighlightColor(ContextCompat.getColor(NewWelcomeActivity.this, R.color.transparent));
