...
public class RegistrationStateActivity extends AppCompatActivity implements  CustomHeightAdapter.ListItemClickListener{
    ...
    private String state_id = "", ragister_id,country_id;
    ...
    private void setList() {
        ...
        CustomHeightAdapter adapter = new CustomHeightAdapter(stateArrayList, "", this, getContext());
    ...
    private void goToNext() {
        Intent in = new Intent(this, RegistrationCityActivity.class);
    ...
    private void getDependentList() {
        ...
        HashMap<String, String> param = new HashMap<>();
        param.put("get_list", "state_list");
        param.put("currnet_val", country_id);
        param.put("multivar", "");
        param.put("retun_for", "");
        ...
        common.makePostRequest(AppConstants.common_depedent_list, param, response -> {
            ...
            try {
                ...
                if (object.getString("status").equals("success")) {
                    ...
                    stateArrayList.addAll(common.getSpinnerListFromArray(jsonArray));
                    setList();
