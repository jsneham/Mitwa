...
public class ContactViweAdapter extends RecyclerView.Adapter<ContactViweAdapter.ViewHolder> {
    ...
    public ContactViweAdapter(Context mContext, List<DashboardItem> arrayList, View llView) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(inflater.inflate(R.layout.contact_viewed_item, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(item.getBadge()!=null && item.getPlan_status()!=null) {
...
//                holder.btn_short.setLiked(false);
            ...
            holder.tvPostedBy.setText(mContext.getString(R.string.postedby) + " " + item.getProfileCreatedBy());
