...
public class PremiumPlanAdapter extends CardSliderAdapter<PremiumPlanAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cell_premium_plan_new, parent, false);
    ...
    public void bindVH(ViewHolder viewHolder, int i) {
        ...
        viewHolder.tv_detail.setText(item.getPlanDuration());
       ...
       // viewHolder.lblPlanAmount.setText(item.getPlanAmountType() + " " + item.getPlanAmount());
        ...
        viewHolder.tv_per_day.setText("Per Day " + amountType + "" + new DecimalFormat("##.##").format(perDayAmount));
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView layChat,tv_detail;
