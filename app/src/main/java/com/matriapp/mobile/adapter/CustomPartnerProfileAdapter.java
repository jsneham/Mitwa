...
public class CustomPartnerProfileAdapter extends RecyclerView.Adapter<CustomPartnerProfileAdapter.ViewHolder>  {
     ...
     *                by RecyclerView.
     */
    public CustomPartnerProfileAdapter(List<PartnerFields> dataSet,
                                       Context context) {
    ...
    @Override
    public CustomPartnerProfileAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        // Create a new view, which defines the UI of the list item
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.custom_partner, viewGroup, false);

        return new CustomPartnerProfileAdapter.ViewHolder(view);
    }

    // Replace the contents of a view (invoked by the layout manager)
    @Override
    public void onBindViewHolder(CustomPartnerProfileAdapter.ViewHolder viewHolder, final int position) {
        ...
        if (sm.getType().equalsIgnoreCase("Yes")) {
