...
public class RecentListAdapter extends RecyclerView.Adapter<RecentListAdapter.ViewHolder> {
    ...
    public RecentListAdapter(Context mContext, List<DashboardItem> arrayList, FrameLayout llView) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvMaitId.setText(item.getMatri_id());
//        holder.tv_name.setText(item.getName());
//        holder.tvPostedBy.setText(item.getProfileCreatedBy());
